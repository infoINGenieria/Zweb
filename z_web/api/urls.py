...
from api.views import (
    ...
    ReportAsistenciaSummaryDownloadView, LubricantesItemTallerViewSet
)
...
router.register(
    r'taller/valores/items-lubricantes', LubricantesItemTallerViewSet, base_name='items_lubricantes'
)
router.register(
