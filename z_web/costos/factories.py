...
from costos.models import Costo, CostoParametro, CostoTipo, CostoReal, CostoProyeccion


class CostoParametroFactory(factory.django.DjangoModelFactory):
